...
ccsr_to_dx_o2 AS (
    SELECT 'ccsr_to_dx' AS combination, 2 AS markov_order, member_segment
        ,SUM(transition_count * conditional_entropy) / SUM(transition_count)
        ,APPROX_QUANTILES(conditional_entropy, 2)[OFFSET(1)]
        ,SUM(transition_count)
        ,COUNT(DISTINCT current_ccsr_v1)
...
ccsr_to_ccsr_o2 AS (
    SELECT 'ccsr_to_ccsr' AS combination, 2 AS markov_order, member_segment
        ,SUM(transition_count * conditional_entropy) / SUM(transition_count)
        ,APPROX_QUANTILES(conditional_entropy, 2)[OFFSET(1)]
        ,SUM(transition_count)
        ,COUNT(DISTINCT current_ccsr_v1)
...
SELECT combination, markov_order, member_segment
    ,weighted_avg_entropy, median_entropy
    ,total_transitions, unique_current_states
FROM dx_to_specialty_o1
UNION ALL SELECT * FROM dx_to_dx_o1
UNION ALL SELECT * FROM dx_to_ccsr_o1
UNION ALL SELECT * FROM specialty_to_specialty_o1
UNION ALL SELECT * FROM specialty_to_dx_o1
UNION ALL SELECT * FROM specialty_to_ccsr_o1
UNION ALL SELECT * FROM ccsr_to_specialty_o1
UNION ALL SELECT * FROM ccsr_to_dx_o1
UNION ALL SELECT * FROM ccsr_to_ccsr_o1
UNION ALL SELECT * FROM dx_to_specialty_o2
UNION ALL SELECT * FROM dx_to_dx_o2
UNION ALL SELECT * FROM dx_to_ccsr_o2
UNION ALL SELECT * FROM specialty_to_specialty_o2
UNION ALL SELECT * FROM specialty_to_dx_o2
UNION ALL SELECT * FROM specialty_to_ccsr_o2
UNION ALL SELECT * FROM ccsr_to_specialty_o2
UNION ALL SELECT * FROM ccsr_to_dx_o2
UNION ALL SELECT * FROM ccsr_to_ccsr_o2
ORDER BY weighted_avg_entropy ASC, markov_order ASC, member_segment
