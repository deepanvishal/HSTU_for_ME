-- ============================================================
-- STEP 0: ref_specialty_crosswalk_expanded
-- PURPOSE: EXPANDED CMS SPECIALTY TO AETNA SPECIALTY_CD MAPPING
--          MAPS ON specialty_cd (raw code from RPDB_RPNPRAC)
-- TOTAL:   327 ROWS ACROSS 43 CMS SPECIALTIES
-- NOTE:    Excludes pediatric, telehealth, palliative,
--          and non-CMS specialty codes
-- ============================================================
...
SELECT * FROM UNNEST([
  ...
  STRUCT('General Surgery' AS cms_specialty, '30201' AS aetna_code, 'Surgery, Colon & Rectal' AS aetna_description),
  ...
  STRUCT('Neurosurgery' AS cms_specialty, '30301' AS aetna_code, 'Surgery, Neurological' AS aetna_description),
  ...
  STRUCT('Oncology Medical/Surgical' AS cms_specialty, '10309' AS aetna_code, 'Hematology' AS aetna_description),
