# ============================================================
# Model_02_bert4rec_train.py
# Purpose : Train BERT4Rec on pre-built train dataset
# Input   : ./cache_model_data_{SAMPLE}/train_*.npy + vocab.pkl
# Output  : /home/jupyter/models/bert4rec_{SAMPLE}_{TS}.pt
#           /home/jupyter/models/bert4rec_{SAMPLE}_{TS}_vocab.pkl
# ============================================================
import gc
import os
import pickle
...
MASK_IDX        = NUM_SPECIALTIES + 1
N_train = train_data["seq_matrix"].shape[0]
N_val   = val_data["seq_matrix"].shape[0]

print(f"Train: {N_train:,} | Val: {N_val:,} | Vocab: {NUM_SPECIALTIES:,} | MASK_IDX: {MASK_IDX}")
...
print("Model_02_bert4rec_train complete")
